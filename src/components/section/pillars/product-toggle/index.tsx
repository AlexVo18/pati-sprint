...
export const ProductToggle = ({ isEssentials, setActiveProduct }: Props) => {
  return (
    <div className="flex justify-center mb-12 lg:mb-18">
      ...
      >
        <button
          ...
          className={`relative z-2 inline-flex items-center justify-center px-6 py-3.5 md:px-8 md:py-4 border-none bg-transparent text-[13px] md:text-sm font-medium tracking-[0.03em] cursor-pointer transition-all duration-280 whitespace-nowrap flex-1 min-w-0 ${
        ...
        <span
          className="absolute top-1.5 h-[calc(100%-12px)] w-[calc(50%-6px)] rounded-full z-1 transition-all duration-500"
          style={{
