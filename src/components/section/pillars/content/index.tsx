  ...
  return (
    <div
      ...
      style={{
        ...
        borderWidth: "2px",
        borderStyle: "solid",
        borderColor: isEssentials
          ? "rgba(164, 0, 17, 0.08)"
          : "rgba(231, 141, 45, 0.15)",
    ...
    >
      <div
        className="absolute top-0 left-0 right-0 h-75 pointer-events-none z-0"
        style={{
          background: isEssentials
      ...
      <div className="relative z-1 p-7 md:p-11 lg:p-13">
        <div className="flex items-start justify-between mb-7">
          <div
            className="w-18 h-18 md:w-22 md:h-22 flex items-center justify-center rounded-4xl md:rounded-[24px]"
            style={{
              background: isEssentials
              ...
              border: isEssentials
                ? "1px solid rgba(80, 0, 11, 0.06)"
                : "1px solid rgba(231, 141, 45, 0.15)",
            }}
          >
            <div className="w-[55%] h-[55%]">{pillar.icon}</div>
          </div>

          <div
            className="inline-flex items-center px-4 py-2 rounded-full text-[11px] font-semibold tracking-widest uppercase text-white"
            style={{
        ...
        <div className="max-w-135">
          ...
          <div className="flex items-center gap-4 mb-7">
            <span
              className="w-8 h-px shrink-0 opacity-40"
          ...
          <div
            ...
            style={{ borderColor: "rgba(80, 0, 11, 0.06)" }}
          >
            <h4
