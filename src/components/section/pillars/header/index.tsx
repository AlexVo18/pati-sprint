...
const Header = ({ isEssentials }: Props) => {
  return (
    <header className="text-center mb-12 lg:mb-18 relative">
      ...
      <p
        className="text-[clamp(15px,2vw,18px)] font-normal leading-[1.7] max-w-170 mx-auto m-0 opacity-90"
      ...
      <div
        className="w-15 h-0.75 rounded-sm mt-7 mx-auto"
        style={{
          background: isEssentials
