import type { FeatureCard } from "@/types/pillars.type";
...
const Cards = ({ cards, isEssentials }: Props) => {
  return (
    <div className="relative">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
        {cards.map((card, idx) => (
          <div
            key={idx}
            className="relative p-7 md:p-9 bg-white border rounded-4xl md:rounded-[24px] text-center overflow-hidden transition-all duration-280 hover:-translate-y-0.5"
            style={{
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                "0 8px 32px rgba(80, 0, 11, 0.08), 0 2px 8px rgba(80, 0, 11, 0.04)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.borderColor = "rgba(80, 0, 11, 0.06)";
              e.currentTarget.style.boxShadow =
                "0 2px 8px rgba(80, 0, 11, 0.04)";
            }}
          >
            <div
            ...
            >
              <div className="w-[55%] h-[55%]">{card.icon}</div>
            </div>
            <h4
