import { FeatureIcons } from "@/icons/feature-icon";
import { PillarIcons } from "@/icons/pillar-icon";
import type { FeatureCard, Pillar, ProductType } from "@/types/pillars.type";
  ...
  longevity: [
    {
      ...
      benefits: ["L-Glycine 3,000mg", "Taurine 2,000mg"],
    },
    {
      id: 1,
      number: "02",
    ...
    },
    {
      ...
      benefits: ["Dihydroberberine 100mg", "Astaxanthin 6mg"],
    },
    {
      id: 4,
      number: "05",
